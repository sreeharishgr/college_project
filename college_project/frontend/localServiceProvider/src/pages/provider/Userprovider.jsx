...
//         <Avatar sx={{ width: 64, height: 64, bgcolor: `${color}1A`, color }}>{icon}</Avatar>
...
//   return (
//     <Box component="main" id="main" sx={{ bgcolor: "#E9F1FF", minHeight: "100vh" }}>
//       <NavBar />
...
//       {/* Hero area */}
//       <Container component="section" aria-labelledby="choice-heading" maxWidth="lg" sx={{ py: { xs: 6, md: 10 }, textAlign: "center" }}>
...
//             Find Local Services
//           </Typography>
//         <Typography sx={{ color: "#64748B", fontSize: { xs: "0.95rem", md: "1rem" } }}>
